...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1.0026075195; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 18.0; // in
     ...
     * empirically tuned.
     */
    public static double kV = 0.0173;// / rpmToVelocity(MAX_RPM);
    ...
    public static double MAX_ANG_VEL = 3.0390546321868896;
    public static double MAX_ANG_ACCEL = 3.3859947796680827;
